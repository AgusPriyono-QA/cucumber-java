...
public class Constants {
 ...
 // Parameter data input - start
 	public static final String username = "agus_05";
 	public static final String password = "12345678Admi@Dmin";
 	public static final String firstName = "agus";
 	public static final String lastName = "priyono";
 	public static final String streetAddress = "Jalan Pintu Air";
 	public static final String city = "Jakarta Pusat";
 	public static final String postCode = "14110";
 	public static final String phone = "08778773334";
 	public static final String email = "priyonoagus005@gmail.com";
